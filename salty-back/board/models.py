...
class Matchup(models.Model):
    name1 = models.ForeignKey(
        Champion, on_delete=models.CASCADE, related_name="name1", null=True
    )
    name2 = models.ForeignKey(
        Champion, on_delete=models.CASCADE, related_name="name2", null=True
    )
...
class Match(models.Model):
    ...
    winner = models.ForeignKey(
        Champion, on_delete=models.CASCADE, related_name="red", null=True
    )
    looser = models.ForeignKey(
        Champion, on_delete=models.CASCADE, related_name="blue", null=True
    )
