...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for line in lines:
            data = line.split(";")
            print(data[0][:-1])
            champ, created = Champion.objects.get_or_create(name=data[0][:-1], defaults={'wins': int(data[1]), 'losses': int(data[2]), 'avgBetShare' : 0.5})
            if not created :
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        Matchup.objects.create(name1=champ1, name2=champ2, wins1=int(data[2]), wins2=int(data[3]), betShare1=0.5)
